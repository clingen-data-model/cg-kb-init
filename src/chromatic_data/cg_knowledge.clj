...
(def external-data
  [
   ...
   ["https://github.com/monarch-initiative/SEPIO-ontology/raw/master/src/ontology/sepio.owl"
    "data/sepio.owl" :import-ontology]
   ;;["http://data.bioontology.org/ontologies/NCIT/submissions/60/download?apikey=8b5b7825-538d-40e0-9e9e-5ab9274a9aeb" "data/ncit.owl" :import-ontology]
   ;;["https://github.com/monarch-initiative/monarch-disease-ontology/raw/master/src/mondo/mondo.owl" "data/mondo.owl" :import-ontology]
                                        ;["https://github.com/monarch-initiative/SEPIO-ontology/raw/master/src/ontology/extensions/domain/sepio-vi.owl" "data/sepio-vi.owl" :import-ontology]
...
(defn init-kb
  ...
  (owl/import-ontology "ontology/clingen.owl")
  (doseq [a external-data]
    (import-asset a))
